describe("Audio", function()
  describe("FrameSequencer", function()
    ...
    it("dividing timer clocks the frame sequencer on reset", function()
      frame_sequencer.timer:reload(10)
      frame_sequencer.timer:advance(10)
      assert.are_same(1, frame_sequencer.step)
    end)
  end)
end)