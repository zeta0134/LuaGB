describe("Audio", function()
  describe("Registers", function()
    ...
    it("NR10-NR52 read back all 1's for their unused bits, length and frequency counters", function()
      local read_masks = {
      ...
      for address = 0xFF00 + ports.NR10, 0xFF00 + ports.NR52 do
        local mask = read_masks[address - (0xFF00 + ports.NR10) + 1]
