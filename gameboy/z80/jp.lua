...
function apply(opcodes, opcode_cycles, z80, memory)
  ...
  -- jr nn
  opcode_cycles[0x18] = 8
  opcodes[0x18] = function()
    jump_relative_to_nn()
  end

  -- jr nz, nn
  opcode_cycles[0x20] = 8
